...
trait LinkColor{
    /**
     * Extracts the link text color from the attributes array
     * 
     ...
     */
    function linkTextColor(): BlockStyleValue{
        //flag to check if the color is a preset value
        $isPreset = false;
        $color = null;
    
        //both presets and custom values are stored in the $this->attributes['style']['elements']['link']['color']['text'] location
        if (!empty($this->attributes['style']['elements']['link']['color']['text'])) {
            $color = $this->attributes['style']['elements']['link']['color']['text'];
