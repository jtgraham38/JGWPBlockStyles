...
trait Typography{
    ...
    function fontSize(): BlockStyleValue{
        ...
        //first, try to extract from the $this->attributes['style']['typography']['fontSize'] location
        ...
        //then, try to extract from the $this->attributes['fontSize'] location
        //this is for preset values
        else if (!empty($this->attributes['fontSize'])) {
            $isPreset = true;
